/*using kumarasannatask.model;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;
using System.Text.Json.Serialization;

namespace kumarasannatask.Controllers
{
    [ApiController]
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public object get()
        {
            string name = System.IO.File.ReadAllText(@"H:\Sivallingam\kumarasannatask\kumarasannatask\jsconfig.json");
            Employee[] value = JsonConvert.DeserializeObject<Employee[]>(name);
            var mani = $"id : {value[1].Id}";
            return mani;
        }
    }
}*/
